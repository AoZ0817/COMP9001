...
Click "🆕 New Game" button in the top-right corner
Enter your club name (e.g., "Manchester United", "Dream FC")
Click "Create"
Your club will be created with:
...
Look at the Squad List (center panel)
Note which players have high OVR (70-85 for starters)
Check stamina levels (should be 100% initially)
Step 2: Your First Match
Click "⚽ Play Match"
Watch the match result pop-up:
Shows final score
...
Select a player with low stamina (click on them in the list)
Click "😴 Rest Selected"
Player recovers 30 stamina and 5 morale
Option B: Train Players

Select a player with good stamina (>50%)
Click "🏋️ Train Selected"
May improve overall rating by 1-2 points
Costs 15 stamina
...
Advancing Weeks
Click "📅 Advance Week"
Salaries are automatically deducted
If budget < total salaries = GAME OVER
Players automatically recover:
+10 stamina
...
Select and click "💰 Buy Selected Player"
Example Purchase:
...
Rest Match 1 starters
Use reserves for Match 2
First team recovers while reserves play
...
File saved as football_manager_save.json
Loading Saves:
...
Read the Gameplay Tutorial section
